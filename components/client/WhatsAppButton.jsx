        ...
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
            ...
            {(showTooltip || isHovered) && (
                <div className="relative animate-in fade-in slide-in-from-right-2 duration-300">
                    <div className="bg-white rounded-lg shadow-lg border px-4 py-3 max-w-[200px]">
                        <button
                        ...
                        <p className="text-xs text-gray-500 mt-1">Chat with your POC on WhatsApp</p>
                    </div>
                    {/* Arrow */}
                    <div className="absolute bottom-0 right-4 w-3 h-3 bg-white border-r border-b rotate-45 -mb-1.5"></div>
                </div>
            )}
            ...
            <button
                ...
                className="group relative w-14 h-14 rounded-full shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-green-500/30"
                style={{
            ...
            >
                ...
                <span className="absolute inset-0 rounded-full animate-ping opacity-25 bg-green-400"></span>
