    ...
    const handleUploadBulkOption = async (e) => {
                ...
                try {
                    ...
                    const mappedClients = parsed.map(row => {
                        ...
                        return {
                            ...
                            amount: Number(row['Initial Amount']) || 0,
                            status: 'active'
                        };
        ...
        const handleDownloadSample = async () => {
            try {
                ...
                const data = [
                    {
                        'Admin Name': 'Ali Asgar',
                        'Team': 'PSOA-S',
                        'Supervisor': 'Zainab Husain',
                        'SP Central Request ID': 'None',
                        'Company Name': 'Example Company Ltd',
                        'Seller Name': 'John Doe',
                        'Email ID': 'john.doe@example.com',
                        'Phone Number': '9876543210',
                        'Customer ID/Merchant Token': 'TOKEN123',
                        'Stage': 'Support Ongoing',
                        'Marketplace': 'Amazon.in',
                        'User Permission Access Name': 'user@example.com',
                        'Lead Source': 'CTRL',
                        'Sales Manager': 'Areen Qureshi',
                        'Discount': '0.2',
                        'Plan': 'Elite Quarterly (LS)',
                        'Support SLA (TAT)': 'Next Day',
                        'Launch Week No.': 'Week-8',
                        'Subscription Start Date': '19/03/2026',
                        'Subscription End Date': '19/04/2026',
                        'POE (Proof Of Engagement)': 'None',
                        'Initial Amount': 2000
                    }
                ];
                ...
                xlsx.writeFile(wb, "client_bulk_upload_sample.xlsx");
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    ...
                                                    <div className="bg-muted/30 p-5 rounded-2xl border border-border/50 space-y-5 flex flex-col shadow-sm">
                                                        ...
                                                        <div className="grid gap-2">
                                                            ...
                                                            <Input type="number" value={newClientData.amount || ""} onChange={(e) => setNewClientData({ ...newClientData, amount: e.target.value })} placeholder="e.g. 5000" />
                                                        </div>
                                                        <div className="grid gap-2">
                                                ...
                                                <div className="border-2 border-dashed border-primary/20 bg-primary/5 rounded-xl p-12 flex flex-col items-center justify-center text-center max-w-2xl mx-auto w-full">
                                                    ...
                                                    <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                                                        <Button
                                                            ...
                                                            className="shadow-sm border-primary/30 text-primary hover:bg-primary/5"
                                                        >
                                                        ...
                                                        <Button
                                                            ...
                                                            className="shadow-md"
                                                        >
                                                            {isUploadingBulk ? <Loader2 className="h-5 w-5 mr-2 animate-spin" /> : <Layers className="h-5 w-5 mr-2" />}
                                                            Browse Excel file
                                                        </Button>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="py-2">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div className="bg-muted/30 p-5 rounded-2xl border border-border/50 space-y-5 flex flex-col shadow-sm">
                                                ...
                                                <div className="grid gap-2">
                                                    <label className="text-sm font-medium">Initial Amount (Manual)</label>
                                                    <Input
                                                        type="number"
                                                        value={editClientData.amount || ""}
                                                        onChange={(e) => setEditClientData({ ...editClientData, amount: e.target.value })}
                                                        placeholder="e.g. 5000"
                                                    />
                                                    <p className="text-[10px] text-muted-foreground italic">Add manual payment amount that doesn't require an invoice.</p>
                                                </div>
                                            </div>
                                        </div>
