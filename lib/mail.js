        ...
        html: `
            <div style="font-family: 'Inter', 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 650px; margin: 20px auto; border: 1px solid #e2e8f0; border-radius: 16px; overflow: hidden; background-color: #ffffff; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 2px 4px -1px rgba(0, 0, 0, 0.03);">
                ...
                <div style="padding: 40px 30px;">
                    ...
                    ${data.showSecurityTip !== false ? `
                    <div style="background-color: #fff1f2; border-left: 4px solid #880808; padding: 15px 20px; border-radius: 0 8px 8px 0; margin-bottom: 30px;">
                        <p style="margin: 0; color: #9f1239; font-size: 14px; line-height: 1.5;">
                            <strong>Security Tip:</strong> You can change this auto-generated password at any time by navigating to your Profile Settings inside the dashboard.
                        </p>
                    </div>
                    ` : ''}

                    <div style="text-align: center; margin-top: 30px;">
                        <a href="${data.dashboardUrl || 'https://www.fakhriitservices.com/login'}" style="display: inline-block; padding: 14px 35px; background-color: #880808; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 15px; box-shadow: 0 4px 6px -1px rgba(136, 8, 8, 0.2);">Log In to Your Dashboard</a>
                    </div>
                </div>
               
                <div style="background-color: #f8fafc; padding: 25px 30px; text-align: center; border-top: 1px solid #e2e8f0;">
                    <p style="margin: 0 0 10px 0; font-size: 14px; color: #475569;">Need help getting started? <a href="mailto:support@fakhriit.com" style="color: #880808; font-weight: 600; text-decoration: none;">Contact our support team</a></p>
